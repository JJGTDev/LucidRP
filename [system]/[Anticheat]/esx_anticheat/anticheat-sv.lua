...
AddEventHandler('AntiCheat:Cars', function(blacklistedCar)
	...
	TriggerEvent('DiscordBot:ToDiscord', 'cheat', fal2.."CHEAT", "Got into a blacklist vehicle - "..blcar, 'IMAGE_URL', true)
...
AddEventHandler('AntiCheat:Jump', function()
	...
	local name = GetPlayerName(source)
	fal2 = name.." "..identifier
	TriggerEvent('DiscordBot:ToDiscord', 'cheat', fal2.."CHEAT", "Super jump", 'IMAGE_URL', true)
