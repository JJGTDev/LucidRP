...
$(function() {
	...
	window.addEventListener("message", function(event) {
		...
		if (item.positionType == 'right-side') {
			radarContainer.addClass("right-side");
		} else if (item.positionType == 'right-side-middle') {
			radarContainer.removeClass("right-side");
			radarContainer.addClass("right-side-middle");
		} else {
			radarContainer.removeClass("right-side");
			radarContainer.removeClass("right-side-middle");
		}
