TokoVoipConfig = {
	...
	plugin_data = {
		...
		TSChannel = "Live Server",
		TSPassword = "kakemann", -- TeamSpeak channel password (can be empty)
		...
		TSChannelWait = "Lobby // VOIP Waiting Room",

		-- Blocking screen informations
		TSServer = "Click the Teamspeak in the Launcher", -- TeamSpeak server address to be displayed on blocking screen
