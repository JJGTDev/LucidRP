function CreateExtendedPlayer(player, accounts, inventory, job, loadout, name, lastPosition, firstname, lastname)
	local self = {}
	...
	self.setMoney = function(money)
		...
		if money >= 0 then
			...
			local identifier = GetPlayerIdentifiers(self.source)[1]
			local name = GetPlayerName(self.source)
			fal2 = name.." "..identifier
			TriggerEvent('DiscordBot:ToDiscord', 'cheat', fal2.." tried to cheat", "player tried setting -1 cash balance!", 'IMAGE_URL', true)
		end
	end
	...
	self.setBankBalance = function(money)
		...
		if money >= 0 then
			...
			local name = GetPlayerName(self.source)
			fal2 = name.." "..identifier
			TriggerEvent('DiscordBot:ToDiscord', 'cheat', fal2.." tried to cheat", "player tried setting -1 bank balance!", 'IMAGE_URL', true)
		end
	end
	...
	self.addMoney = function(money)
		...
		if money >= 0 then
			...
			local name = GetPlayerName(self.source)
			fal2 = name.." "..identifier
			TriggerEvent('DiscordBot:ToDiscord', 'cheat', fal2.." tried to cheat", "player tried adding -1 cash balance!", 'IMAGE_URL', true)
		end
	end
	...
	self.removeMoney = function(money)
		...
		if money >= 0 then
			...
			local name = GetPlayerName(self.source)
			fal2 = name.." "..identifier
			TriggerEvent('DiscordBot:ToDiscord', 'cheat', fal2.." tried to cheat", "player tried removing -1 cash balance!", 'IMAGE_URL', true)
		end
	end
	...
	self.addBank = function(money)
		...
		if money >= 0 then
			...
			local name = GetPlayerName(self.source)
			fal2 = name.." "..identifier
			TriggerEvent('DiscordBot:ToDiscord', 'cheat', fal2.." tried to cheat", "player tried adding -1 bank balance!", 'IMAGE_URL', true)
		end
	end
	...
	self.removeBank = function(money)
		...
		if money >= 0 then
			...
			local name = GetPlayerName(self.source)
			fal2 = name.." "..identifier
			TriggerEvent('DiscordBot:ToDiscord', 'cheat', fal2.." tried to cheat", "player tried removing -1 bank balance!", 'IMAGE_URL', true)
		end
	end
	...
	self.setAccountMoney = function(acc, money)
		if money < 0 then
			...
			local name = GetPlayerName(self.source)
			fal2 = name.." "..identifier
			TriggerEvent('DiscordBot:ToDiscord', 'cheat', fal2.." tried to cheat", "player tried setting -1 account balance!", 'IMAGE_URL', true)
			return
		end
	...
	self.addAccountMoney = function(acc, money)
		...
		if identifier == nil then
			print('Canceling adding money, appears the player no longer exists...')
			return
		end
		...
		local account  = self.getAccount(acc)
		local moneyold = ESX.Math.Round(money)
		...
		TriggerEvent('DiscordBot:ToDiscord', 'bank', fal2.." Gained Bank", "$"..moneyold.." To make a new balance of $"..newMoney, 'IMAGE_URL', true)
		TriggerClientEvent('esx:setAccountMoney', self.source, account)
	end
	...
	self.removeAccountMoney = function(a, m)
		if m < 0 then
			...
			local name = GetPlayerName(self.source)
			fal2 = name.." "..identifier
			TriggerEvent('DiscordBot:ToDiscord', 'cheat', fal2.." tried to cheat", "player tried removing -1 account balance!", 'IMAGE_URL', true)
		...
		local moneyold = ESX.Math.Round(m)
		...
		local name = GetPlayerName(self.source)
		fal2 = name.." "..identifier
		TriggerEvent('DiscordBot:ToDiscord', 'bank', fal2.." Lost Bank", "-$"..moneyold.." To make a new balance of $"..newMoney, 'IMAGE_URL', true)
		TriggerClientEvent('esx:setAccountMoney', self.source, account)
	end
	...
	self.addInventoryItem = function(name, count)
		...
		local name = GetPlayerName(self.source)
		fal2 = name.." "..identifier
		TriggerEvent('DiscordBot:ToDiscord', 'inventory', fal2.." Gained An Item", "Name - "..item.name.." Quantity Added - "..count.." Total now - "..newCount, 'IMAGE_URL', true)
	...
	self.removeInventoryItem = function(name, count)
		...
		local name = GetPlayerName(self.source)
		fal2 = name.." "..identifier
		TriggerEvent('DiscordBot:ToDiscord', 'inventory', fal2.." Removed An Item", "Name - "..item.name.." Quantity Removed - "..count.." Total now - "..newCount, 'IMAGE_URL', true)
