Config.Weapons = {
...

	{
		...
		components = {
			...
			{ name = 'clip_hollowpoint', label = _U('component_clip_hollowpoint'), hash = GetHashKey('COMPONENT_PISTOL_MK2_CLIP_HOLLOWPOINT') },
...

	{
		...
		components = {
			...
			{ name = 'clip_box', label = _U('component_clip_box'), hash = GetHashKey('COMPONENT_CARBINERIFLE_MK2_CLIP_03') },
			{ name = 'flashlight', label = _U('component_flashlight'), hash = GetHashKey('COMPONENT_AT_AR_FLSH') },
			{ name = 'scope', label = _U('component_scope'), hash = GetHashKey('COMPONENT_AT_SCOPE_MACRO_MK2') },
			{ name = 'suppressor', label = _U('component_suppressor'), hash = GetHashKey('COMPONENT_AT_AR_SUPP') },
			{ name = 'grip', label = _U('component_grip'), hash = GetHashKey('COMPONENT_AT_AR_AFGRIP_02') },
			{ name = 'tracers', label = 'Tracer Rounds', hash = GetHashKey('COMPONENT_CARBINERIFLE_MK2_CLIP_TRACER') },
			{ name = 'luxary_finish', label = _U('component_luxary_finish'), hash = GetHashKey('COMPONENT_CARBINERIFLE_MK2_CAMO_04') }
		}
	},
