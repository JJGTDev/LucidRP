...
local function drawTitle()
	if menus[currentMenu] then
		...
		if menus[currentMenu].titleBackgroundSprite then
			...
			drawRect(x, y+0.3, menuWidth, titleHeight, menus[currentMenu].titleBackgroundColor)
		end

		drawText(menus[currentMenu].title, x, y - titleHeight / 2 + titleYOffset+0.3, menus[currentMenu].titleFont, menus[currentMenu].titleColor, titleScale, true)
	end
end
...
local function drawSubTitle()
	if menus[currentMenu] then
		...
		drawRect(x, y+0.3, menuWidth, buttonHeight, menus[currentMenu].subTitleBackgroundColor)
		drawText(menus[currentMenu].subTitle, menus[currentMenu].x + buttonTextXOffset, y - buttonHeight / 2 + buttonTextYOffset+0.3, buttonFont, subTitleColor, buttonScale, false)
...
local function drawButton(text, subText)
	...
	if multiplier then
		local y = menus[currentMenu].y + titleHeight + buttonHeight + (buttonHeight * multiplier) - buttonHeight / 2 + 0.3
...
function WarMenu.CreateMenu(id, title)
	...
	menus[id].titleBackgroundColor = { r = 200, g = 30, b = 37, a = 255 }
	menus[id].titleBackgroundSprite = nil

	menus[id].menuTextColor = { r = 255, g = 255, b = 255, a = 255 }
	menus[id].menuSubTextColor = { r = 189, g = 189, b = 189, a = 255 }
	menus[id].menuFocusTextColor = { r = 243, g = 245, b = 245, a = 255 }
	menus[id].menuFocusBackgroundColor = { r = 150, g = 131, b = 131, a = 255 }
